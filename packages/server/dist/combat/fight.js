...
import { resolveExchange } from "./resolve.js";
...
export class Fight {
    ...
    p1Hp = MAX_HP;
    p2Hp = MAX_HP;
    p1Stamina = MAX_STAMINA;
    p2Stamina = MAX_STAMINA;
    p1RoundWins = 0;
    p2RoundWins = 0;
    round = 1;
    exchange = 1;
    ...
    submitAction(agentId, action) {
        ...
        if (agentId === this.p1Id) {
            if (this.pendingP1 !== null)
                throw new Error("P1 already submitted action this exchange");
            this.pendingP1 = action;
        }
        else if (agentId === this.p2Id) {
            if (this.pendingP2 !== null)
                throw new Error("P2 already submitted action this exchange");
    ...
    resolve() {
        ...
        const result = resolveExchange(p1Action, p2Action, { hp: this.p1Hp, stamina: this.p1Stamina }, { hp: this.p2Hp, stamina: this.p2Stamina });
    ...
    getWinner() {
        if (this.status !== "fight_over")
            return null;
        if (this.p1RoundWins > this.p2RoundWins)
            return this.p1Id;
        if (this.p2RoundWins > this.p1RoundWins)
            return this.p2Id;
